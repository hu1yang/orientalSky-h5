                      ...
                      <div className={'px-2'}>
                        {
                          item.expandSettings.map(expandSetting => (
                            <CardText key={expandSetting.indexId} label={expandSetting.name} style={'items-start'} value={expandSetting.value} labelStyle={'text-[1.1rem]!'} valueStyle={'text-right text-[1.3rem]!'} />
                          ))
                        }
                      </div>
                    </div>
